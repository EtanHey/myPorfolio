...
const LayoutWOSidebar = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className="w-full overflow-y-auto border-white/20 bg-gradient-to-t from-indigo-300 to-purple-600 p-0 sm:py-2 sm:px-3 md:px-4 lg:px-12 xl:px-56 2xl:px-72">

...
const Modal = () => {
  ...
  return (
    <div
      onClick={closeModal}
      className={`fixed top-1/2 left-1/2 h-full w-screen min-w-fit -translate-x-1/2 -translate-y-1/2  transition-opacity duration-300 sm:px-72 sm:py-24 md:px-80 md:py-28 lg:px-96 lg:py-32 ${
        modal.open ? "bg-black/50 opacity-100" : "pointer-events-none opacity-0"
      }`}
    >
      <dialog
        open
